...
\begin{figure}[!h]
    ...
    % Normal caption
    \vspace{-0.7em}
    \caption{ Scatter plot showing the ratio between running time and solution quality, using the geometric mean for both measures. To normalize the running time per graph, we divide it by the number of edges, yielding a time-per-edge measure. }
