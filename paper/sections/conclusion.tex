...
We surveyed over twenty modularity-based graph clustering algorithms, covering classical heuristics, parallel methods, and recent learning-based approaches. When modularity maximization is the sole objective, the results are clear: \textsc{VieClus} consistently achieves the highest modularity values when sufficient memory is available. \textsc{Leiden}, an improved variant of \textsc{Louvain}, closely follows in solution quality while offering substantially faster runtimes. This trade-off reflects their optimization strategies: \textsc{VieClus} relies on time-budgeted search, whereas \textsc{Leiden} employs a greedy refinement scheme.
