...
There is an implementation available at [GitHub](https://github.com/felixfung/InfoFlow). It needs an old version of Java to work, so I would not recommend using this, but it is possible..