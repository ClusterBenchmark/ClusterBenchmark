...
The paper refers to a [website](http://www.dama.upc.edu/) were the C++ code is supposed to be, however, another project called [CoDACom](https://codacom.greyc.fr/use.html) also provides an implementation of this clustering algorithm. Sadly, the download link seems to be broken.